class ProcessMessage
  ...
  def self.process(message, brains)
    ...
    if (message.split(' ') & brains.all_speakers_list).any?
      ...
      if answer == "speaker"
        ...
        brains.respond_normal(brains.fetch_question)
      ...
      brains.respond_message(brains.fetch_jokes)
      ...
      brains.respond_normal(brains.fetch_lol)

    elsif (message.split(' ') & brains.wishes).any?
      brains.respond_normal(brains.fetch_wishes)
